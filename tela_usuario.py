...
class Tela_Usuario(object):
    def setupUi(self, MainWindow):
        ...
        self.nome_user_edit.setGeometry(QtCore.QRect(170, 260, 181, 25))
        self.nome_user_edit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.nome_user_edit.setObjectName("nome_user_edit")
        self.nome_user_label = QtWidgets.QLabel(self.centralwidget)
        self.nome_user_label.setGeometry(QtCore.QRect(19, 262, 61, 21))
        self.nome_user_label.setObjectName("nome_user_label")
        self.sobnome_user_label = QtWidgets.QLabel(self.centralwidget)
        self.sobnome_user_label.setGeometry(QtCore.QRect(20, 300, 131, 21))
        self.sobnome_user_label.setObjectName("sobnome_user_label")
        self.sobnome_user_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.sobnome_user_edit.setGeometry(QtCore.QRect(170, 301, 181, 25))
        self.sobnome_user_edit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.sobnome_user_edit.setObjectName("sobnome_user_edit")
        ...
        self.cpf_user_edit.setGeometry(QtCore.QRect(170, 340, 181, 25))
        self.cpf_user_edit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.cpf_user_edit.setObjectName("cpf_user_edit")
        self.numconta_user_label = QtWidgets.QLabel(self.centralwidget)
        self.numconta_user_label.setGeometry(QtCore.QRect(21, 219, 121, 21))
        self.numconta_user_label.setObjectName("numconta_user_label")
        self.senha_user_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.senha_user_edit.setGeometry(QtCore.QRect(170, 220, 181, 25))
        self.senha_user_edit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.senha_user_edit.setObjectName("senha_user_edit")
        ...
        self.saldo_user_label.setGeometry(QtCore.QRect(230, 145, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Waree")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.saldo_user_edit.setGeometry(QtCore.QRect(320, 150, 81, 25))
        self.saldo_user_edit.setStyleSheet("background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nome_user_label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ffffff;\">NOME:</span></p></body></html>"))
        self.sobnome_user_label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ffffff;\">SOBRENOME:</span></p></body></html>"))
